...
export interface IUserTwoFactorTokenProvider<TUser extends object> {
    /// <summary>
    ...
    /// </remarks>
    generateAsync(purpose: string, manager: UserManager<TUser>, user: TUser): Promise<string>;
    ...
    /// </returns>
    validateAsync(purpose: string, token: string, manager: UserManager<TUser>, user: TUser): Promise<boolean>;
    ...
    /// </returns>
    canGenerateTwoFactorTokenAsync(manager: UserManager<TUser>, user: TUser): Promise<boolean>;
}
...
export class UserManager<TUser extends object> {
    ...
    async createSecurityTokenAsync(user: TUser): Promise<string> { return ""; }
}