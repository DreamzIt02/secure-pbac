...
export class SiteClaim {
  ...
  static newSignInClaim(): Claim {
    return { type: SiteClaim.SignInClaimType, value: crypto.randomUUID() };
  }

  static defaultClaim(): Claim {
    return { type: AuthorizeClaimTypeEnum[AuthorizeClaimTypeEnum.Default], value: AuthorizeClaimEnum[AuthorizeClaimEnum.Default] };
  }
